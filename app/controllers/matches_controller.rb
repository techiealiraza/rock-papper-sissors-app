class MatchesController < ApplicationController
  ...
  def create_matches
    ...
    tournament = Tournament.find(tournament_id)
    redirect_to tournament_path(tournament_id), notice: 'Matches already Exist' and return if tournament.matches
    ...
    registered_users.each_slice(2) do |user1, user2|
      ...
      matches << usermatches
      tournament_start_time = match_start_time + 2.minutes
      # end
      # else
      #   # matches << registered_users.take(3)
      #   # registered_users.drop(3).each_slice(2) do |user1, user2|
